...
SESSION_FILE = r"C:\Users\user\.claude\REDACTED-PATH\blogger\telegram_session.session"
...
async def send_instructions():
    ...
    # Read message
    msg_file = r'C:\Users\user\.claude\REDACTED-PATH\Transkribator\telegram_message.txt'
    with open(msg_file, 'r', encoding='utf-8') as f:
        message = f.read()

    # Read bat file content
    bat_file = r'C:\Users\user\.claude\REDACTED-PATH\Transkribator\transcriber_server_start.bat'
