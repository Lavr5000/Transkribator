...
$Target = "C:\Users\user\.claude\REDACTED-PATH\Transkribator\main.py"
$IconPath = "C:\Users\user\.claude\REDACTED-PATH\Transkribator\Transcriber.ico"
$WorkingDir = "C:\Users\user\.claude\REDACTED-PATH\Transkribator"
