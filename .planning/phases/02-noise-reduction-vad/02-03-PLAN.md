...
4. Update load_model() to initialize VAD. ANCHOR POINT: Find line `self._recognizer = sherpa_onnx.Recognizer(...)` and insert VAD initialization immediately AFTER it (around line 180):
```python
