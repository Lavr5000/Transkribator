...
$LocalPath = "C:\Users\user\.claude\REDACTED-PATH\Transkribator"
$RemotePC = "REDACTED-TS-IP"
$RemotePath = "C:\Users\user\.claude\REDACTED-PATH\Transkribator"
...
foreach ($File in $FilesToSync) {
    ...
    $Dest = "\\$RemotePC\c$\Users\user\.claude\REDACTED-PATH\Transkribator\$File"
